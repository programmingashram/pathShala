        ...
        <Content style={{ padding: '0 0px' }}>
          <div className="site-layout-content mb-2">
            ...
            <div className='container-fluid my-4 px-4'>
              <h5 className='mb-3'>Coding and UI/UX</h5>
              <Row className='text-center '>
                <Col xs={6} sm={12} md={3} lg={3} xl={3}>
                  <Avatar  size={64} className='mb-3' src={<img src='https://logowik.com/content/uploads/images/react7473.logowik.com.webp' alt="avatar" />} />
                </Col>
                <Col xs={6} sm={12} md={3} lg={3} xl={3}>
                <Avatar size={64} src={<img src='https://cdn.iconscout.com/icon/free/png-256/free-angularjs-1-1175270.png?f=webp' alt="avatar" />} />
                </Col>
                <Col xs={6} sm={12} md={3} lg={3} xl={3}>
                <Avatar size={64} src={<img src='https://static-00.iconduck.com/assets.00/python-icon-512x512-48og66bp.png' alt="avatar" />} />
                </Col>
                <Col xs={6} sm={12} md={3} lg={3} xl={3}>
                <Avatar size={64} src={<img src='https://www.svgrepo.com/show/452088/php.svg' alt="avatar" />} />
                </Col>
                <Col xs={6} sm={12} md={3} lg={3} xl={3}>
                <Avatar size={64} src={<img src='https://www.svgrepo.com/show/303251/mysql-logo.svg' alt="avatar" />} />
                </Col>
                <Col xs={6} sm={12} md={3} lg={3} xl={3}>
                <Avatar size={64} src={<img src='https://cdn-icons-png.flaticon.com/512/5968/5968705.png' alt="avatar" />} />
                </Col>
                <Col xs={6} sm={12} md={3} lg={3} xl={3}>
                <Avatar size={64} src={<img src='https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Adobe_Illustrator_CC_icon.svg/2101px-Adobe_Illustrator_CC_icon.svg.png' alt="avatar" />} />
                </Col>
                <Col xs={6} sm={12} md={3} lg={3} xl={3}>
                <Avatar size={64} src={<img src='https://static-00.iconduck.com/assets.00/adobe-xd-icon-2048x2048-n4c7t4w4.png' alt="avatar" />} />
                </Col>
              </Row>
            </div>
